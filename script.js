...
document.getElementById('product-form').addEventListener('submit', function(event) {
    ...
    */
    const productLocations = {
        'C26301': 'A1A', 'C27955': 'A1A , Cajax1200 Paqx100', 'C28731': 'A1A', 'C37508': 'A1A', 'C74451': 'A1A', 
        'D21547': 'A1A', 'NTJ370': 'A1A', 'NTJ637': 'A1A', 'A14047': 'A1B', 
        ...
        'D00914': 'A2A', 'D00918': 'A2A', 'D35440': 'A2A', 'D35442': 'A2A', 'A01746': 'A2A , Paqx100unds','C31224': 'A2A', 'C27939': 'A2B', 
        '000328': 'A2B', '000350': 'A2B', 'A03143': 'A2B', 'A06503': 'A2B', 'A12930': 'A2B', 'D21539': 'A2B', 
        'C26307': 'A2B', 'A10235': 'A2B', 'D00919': 'A2B', 'C27937': 'A2B , Paqx100unds', '000586': 'A2C', 
        ...
        'C37508CV': 'A4A', 'C49808CV': 'A4A', 'D00914CV': 'A4A', 'D00918CV': 'A4A', 
        'D00919CV': 'A4A', 'NTC456': 'A4A', 'NTX881': 'A4A', 'T01774': 'A4A', 'T03527': 'A4A', 
        'T04377': 'A4A', 'D13591': 'A4B', 'D13602': 'A4B', 'D13607': 'A4B', 'T00641': 'A4B', 
        'T01534': 'A4B', 'T05697': 'A4B', 'T05698': 'A4B', 'D13592': 'A4B , Cajax100 Paqx200', 'NTH961': 'A5A', 
        'NTH965': 'A5A', 'NTJ208': 'A5A', 'NTJ499': 'A5A', 'NTJ500': 'A5A', 'NTO711': 'A5A', 
        'A11870': 'A5B', 'C15443': 'A5B', 'D21087': 'A5B', 'NT/443': 'A5B , Cajax2800 Paqx200', 'NTC752': 'A5B', 
        'NTM183': 'A5B , Cajax700unds, Paqx100unds', 'NTO083': 'A5B', 'A05272': 'A5B', 'A14905': 'A5C , Paqx50', 'C12490': 'A5C', 
        'D13594': 'A5C , Cajax1600 Paqx200', 'D14157': 'A5C', 'A05043': 'A6A , Caja800 Paqx200', 'A09025RL': 'A6A', 'A09026RL': 'A6A', 
        'A09027RL': 'A6A', 'B00278RL': 'A6A', 'C15392': 'A6A', 'C68704': 'A6A', 'NTJ498': 'A6A', 
        'C69675': 'A6A', 'A15625RL': 'A6B',  'Z00116': 'A6B , Cajax288x6Cadisx48', 'Z00150': 'A6B , Cajax210x6cadisx35', 
        'C60447': 'A6C', 'C60451': 'A6C', 'T01049': 'A6C', 'A08017RL': 'A7A', 'A11814RL': 'A7A', 
        'C68701': 'A7A , Paqx200unds', 'C68702': 'A7A , Cajax300 Paqx200','C54853': 'A7A', 'C75491': 'A7B', 'NTC791': 'A7B', 'NTX322RL': 'A7B', 
        'Z00646': 'A7B', 'Z00649': 'A7B', 'Z00663': 'A7B', 'A03883RL': 'A7C', 'D16177': 'A7C', 'T00659': 'A7D', 'T00662': 'A7D', 
        ...
        'NTO712': 'C4A', 'T00366': 'C4B , Cajax600 Paqx100', 'A00983': 'C5A', 'NT/058': 'C5A', 'T01429': 'C5A', 
        ...
        'A01831': 'C8A', 'A01832': 'C8A', 'A01833': 'C8A', 'A01919': 'C8A', 'NTQ814': 'C8A','A01873': 'C8A', 
        ...
        'TZ00557': 'C9C', '700307': 'BOLSA PEQUEÑA PARA EMPACAR',
         'A09955': 'PISO', '700305': 'PISO', 'C17290': 'PISO', 'C50287KG': 'PISO', 'C55715': 'PISO', 
